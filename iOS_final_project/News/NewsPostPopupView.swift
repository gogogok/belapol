...
final class NewsPostPopupView: UIView {
    ...
    private func configureUI() {
        ...
        imageLabel.pinTop(to: nameLabel.bottomAnchor, Constants.spacingNameToUsername)
        imageLabel.pinLeft(to: contentView, Constants.sideInsetLarge)
        imageLabel.pinRight(to: contentView, Constants.sideInsetLarge)
        
        postLabel.pinTop(to: imageLabel.bottomAnchor, Constants.spacingUsernameToPost)
